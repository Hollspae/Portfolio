...
--
-- Хост: 127.0.0.1:3309
-- Время создания: Дек 17 2024 г., 13:30
...
CREATE TABLE `Категория` (
  ...
  `Наименование` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `Пользователь` (
  ...
  `Логин` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Пароль` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `Работа` (
  ...
  `id_года` int NOT NULL,
  `id_категории` int NOT NULL,
  `Фото` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(8, 2, 2, 'https://i.postimg.cc/sXTDpJfY/19-1.jpg'),
...
(17, 3, 2, 'https://i.postimg.cc/pd8sh0ZS/20-4.jpg'),
...
(54, 5, 1, 'https://i.postimg.cc/2Sc8gGNV/5.jpg'),
